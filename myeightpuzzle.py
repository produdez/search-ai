...
class EightPuzzleState(puzzle.PuzzleState):
    ...
    def result(self, move):
        ...
        newPuzzle.cells[row][col] = self.cells[newrow][newcol] #copy blank
        newPuzzle.cells[newrow][newcol] = self.cells[row][col] # copy swapped cell
...
def heuristic_simple_path(state):
    heuristic = 0
    cells = state.cells
    for i in range(3):
        for j in range(3):
